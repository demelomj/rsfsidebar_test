...
livestreams = {'markdown': '', 'spritesheet_path': None, 'banner':''}
upcomingEventsMd = ''
...
# were not retrieved
sidebar = (sidebar.replace('__LIVESTREAMS__', livestreams['markdown']).replace('__UPCOMING_EVENTS__', upcomingEventsMd).replace('__BANNER__', livestreams['banner']))
